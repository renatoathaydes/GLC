...
class GlcProcedureRunnerSpec extends Specification {
    ...
    def "A simple GLC procedure can be run"() {
        ...
        def procedures = glc.compileGlcProcedures( '{ String s -> String t = s + "!"; return t }' ).allProcedures
    ...
    def "A generic GLC procedure can be run"() {
        ...
        def procedures = glc.compileGlcProcedures( '{ List<String> list, Optional<Map<Integer, Long>> opt -> ' +
